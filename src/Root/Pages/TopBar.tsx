...
const TopBar = () => {
  ...
  const fetchUserDetails = async () => {
    const response = await apiGetUserbyAppIdDetails(
      localAppID?.toString() || ""
    );
    ...
    <>
      <div className="navbar">
        ...
        <div className="nav-content">
          ...
          <div id="nav-item" onClick={() => openModalHandler(1)}>
            Support
          </div>
          <div id="nav-item" onClick={() => openModalHandler(2)}>
            Profile
          </div>
        </div>
      </div>
          ...
          <div className="modal">
            <div className="modal-description">
              <div className="close-container">
                <h2 className="profile-txt1">
                  Need help ?
                  <span className="close" onClick={() => closeModalHandler(1)}>
                    &times;
                  </span>
                </h2>
                <h4 className="profile-txt2">
                  Breifly explain us your problem.We will resolve it soon.
                </h4>
              </div>
            ...
            <div className="profile-description">
              <div className="close-container">
                ...
                <div className="icon-container">
                  ...
                  />
                  <h5 className="profile-txt">
                    Details shown here are not editable. Please contact support
                    for addtional help.
                  </h5>
                </div>
              </div>
